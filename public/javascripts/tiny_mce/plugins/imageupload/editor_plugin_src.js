/**
 * ImageUpload TinyMCE Plugin
 *
 * @author Dave Hulihan
 * @copyright Copyright � 2009, Hulihan Applications, All rights reserved.
 */
	...
	tinymce.create('tinymce.plugins.ImageUploadPlugin', {
		...
		getInfo : function() {
			return {
				...
				author : 'Dave Hulihan - Hulihan Applications',
				authorurl : 'http://www.hulihanapplications.com',
				infourl : 'http://ww.hulihanapplications.com/projects/tiny_mce_image_upload/',
				version : "1.0"
			};
		}
	});
